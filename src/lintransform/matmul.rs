...
/// of the Galois group element under the used [`HypercubeStructure`]. Approximating the resulting set
/// of points of `Z^n` by a cubic grid `X { b_i, b_i + s_i, b_i + 2 s_i, ..., b_i + l_i s_i }` then allows
/// us to efficiently find a suitable decomposition.
/// 
