...
/// 
#[instrument(skip_all)]
pub fn slots_to_coeffs_thin<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
        R::Type: Sized + NumberRingQuotient,
        BaseRing<R>: NiceZn
{
...
/// 
#[instrument(skip_all)]
pub fn slots_to_coeffs_fat<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
        R::Type: Sized + NumberRingQuotient,
        BaseRing<R>: NiceZn
{
    MatmulTransform::to_circuit_many(H.ring(), H.hypercube(), slots_to_coeffs_fat_impl(H), max_levels, cost_model)
}
...
/// 
#[instrument(skip_all)]
pub fn slots_to_coeffs_fat_pack<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
        R::Type: Sized + NumberRingQuotient,
        BaseRing<R>: NiceZn
{
    ...
    result = MatmulTransform::to_circuit_many(ring, H.hypercube(), slots_to_coeffs_fat_Xbasis(H), max_levels, cost_model).compose(result, ring);
...
/// 
#[instrument(skip_all)]
pub fn coeffs_to_slots_thin<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
        R::Type: Sized + NumberRingQuotient,
        BaseRing<R>: NiceZn
{
...
/// 
#[instrument(skip_all)]
pub fn coeffs_to_slots_fat<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
        R::Type: Sized + NumberRingQuotient,
        BaseRing<R>: NiceZn
{
    MatmulTransform::to_circuit_many(H.ring(), H.hypercube(), coeffs_to_slots_fat_impl(H), max_levels, cost_model)
}
...
/// 
#[instrument(skip_all)]
pub fn coeffs_to_slots_fat_unpack<R>(H: &HypercubeIsomorphism<R>, max_levels: usize, cost_model: &CircuitEvaluatorCosts) -> PlaintextCircuit<R::Type>
    where R: RingStore,
...
fn test_slots_to_coeffs_non_cyclotomic_ring() {
    ...
    let actual = MatmulTransform::to_circuit_many(&ring, &h, slots_to_coeffs_base(&H), usize::MAX, &DEFAULT_EVALUATOR_COSTS).evaluate(&[input], ring.identity()).pop().unwrap();
...
fn test_coeffs_to_slots_fat_unpack() {
    ...
    let actual = coeffs_to_slots_fat_unpack(&H, usize::MAX, &DEFAULT_EVALUATOR_COSTS).evaluate(&[current], ring.identity());
    ...
    let actual = coeffs_to_slots_fat_unpack(&H, usize::MAX, &DEFAULT_EVALUATOR_COSTS).evaluate(&[ring_literal(&ring, &current)], ring.identity());
