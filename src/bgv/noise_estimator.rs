...
impl<Params: BGVInstantiation, N: BGVNoiseEstimator<Params>> CiphertextDescriptor<Params, N> {
    pub fn new(
        noise: N::CiphertextDescriptor,
        implicit_scale: ImplicitScale<Params>,
...
///    `gen_sk`) are omitted, and randomness (`rng`) and noise standard deviations are not passed in
///    (the latter is folded into [`KeySwitchKeyDescriptor::sigma`] where relevant).
///
...
pub trait BGVNoiseEstimator<Params: BGVInstantiation>: Sized {
    ...
    ///   log2( | c0 + c1 * s |_inf / q )
    /// ```
    fn estimate_log2_relative_noise_level(
        &self,
        P: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> f64;
    ...
    fn clone_ct(
        ...
        C: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> CiphertextDescriptor<Params, Self>;
    ...
    fn hom_add(
        ...
        P: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        lhs: &CiphertextDescriptor<Params, Self>,
        rhs: &CiphertextDescriptor<Params, Self>,
    ...
    fn key_switch(
        ...
        P: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        C_special: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
        switch_key: KeySwitchKeyDescriptor,
    ) -> CiphertextDescriptor<Params, Self>;
    ...
    fn mod_switch_ct(
        &self,
        P: &PlaintextRing<Params>,
        Cnew: &CiphertextRing<Params>,
        Cold: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> CiphertextDescriptor<Params, Self>;
    ...
    fn change_plaintext_modulus(
        &self,
        Pnew: &PlaintextRing<Params>,
        Pold: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> CiphertextDescriptor<Params, Self>;
    ...
    fn merge_implicit_scale(
        ...
        let scale = int_cast(
            P.base_ring()
                .smallest_lift(P.base_ring().invert(&ct.implicit_scale).unwrap()),
            ZZbig,
            P.base_ring().integer_ring(),
        );
    ...
    fn hom_square(
        ...
        C: &CiphertextRing<Params>,
        C_special: &CiphertextRing<Params>,
        val: &CiphertextDescriptor<Params, Self>,
        rk: KeySwitchKeyDescriptor,
    ) -> CiphertextDescriptor<Params, Self> {
    ...
    fn hom_galois_many<'b, V>(
        ...
        gs: &[GaloisGroupEl],
        gks: V,
    ) -> Vec<CiphertextDescriptor<Params, Self>>
    where
        V: VectorFn<KeySwitchKeyDescriptor<'b>>,
    {
        assert_eq!(gs.len(), gks.len());
        (0..gs.len())
            .map(|i| self.hom_galois(P, C, C_special, ct, &gs[i], gks.at(i)))
            .collect()
    }
    ...
    where
        I: IntoIterator<Item = (ImplicitScale<Params>, &'a CiphertextDescriptor<Params, Self>)>,
        Params: 'a,
        Self: 'a,
    {
        ...
        for (m, ct) in summands {
            ...
            let scalar = P
                .base_ring()
                .mul_ref_fst(m.borrow(), P.base_ring().invert(&ct.implicit_scale).unwrap());
    ...
    fn hom_inner_product_plain<L, R, I>(
        &self,
        P: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        summands: I,
    ...
    where
        L: Borrow<El<PlaintextRing<Params>>>,
        ...
        I: IntoIterator<Item = (L, R)>,
    {
        ...
        for (m, ct) in summands {
            ...
            let m_merged = P.inclusion().mul_map(
                P.clone_el(m.borrow()),
    ...
    fn hom_inner_product_plain_encoded<L, R, I>(
        &self,
        P: &PlaintextRing<Params>,
        C: &CiphertextRing<Params>,
        summands: I,
    ...
    where
        L: Borrow<El<CiphertextRing<Params>>>,
        R: Borrow<CiphertextDescriptor<Params, Self>>,
        I: IntoIterator<Item = (L, R)>,
    {
        let mut acc: Option<CiphertextDescriptor<Params, Self>> = None;
...
fn mul_scale<Params: BGVInstantiation>(
    P: &PlaintextRing<Params>,
    lhs: &ImplicitScale<Params>,
    rhs: &ImplicitScale<Params>,
) -> ImplicitScale<Params> {
    P.base_ring().mul_ref(lhs, rhs)
}

fn mod_switch_scale<Params: BGVInstantiation>(
    P: &PlaintextRing<Params>,
    Cnew: &CiphertextRing<Params>,
    Cold: &CiphertextRing<Params>,
    scale: &ImplicitScale<Params>,
) -> ImplicitScale<Params> {
    P.base_ring().mul_ref_fst(
        scale,
        Params::mod_switch_compute_implicit_scale_factor(P, Cnew.base_ring().modulus(), Cold.base_ring().modulus()),
    )
}

fn change_plaintext_modulus_scale<Params: BGVInstantiation>(
    Pnew: &PlaintextRing<Params>,
    Pold: &PlaintextRing<Params>,
    scale: &ImplicitScale<Params>,
) -> ImplicitScale<Params> {
    Pnew.base_ring().coerce(
        Pnew.base_ring().integer_ring(),
        Pold.base_ring()
            .smallest_positive_lift(Pold.base_ring().clone_el(scale)),
    )
}

fn add_scale<Params: BGVInstantiation>(
    P: &PlaintextRing<Params>,
    lhs: &ImplicitScale<Params>,
    rhs: &ImplicitScale<Params>,
    policy: ImplicitScalePolicy,
...
fn t_log2<Params: BGVInstantiation>(P: &PlaintextRing<Params>) -> f64 {
    P.base_ring()
        .integer_ring()
        .to_float_approx(P.base_ring().modulus())
        .log2()
}
...
pub fn assert_sk_distr_match(lhs: SecretKeyDistribution, rhs: SecretKeyDistribution) -> SecretKeyDistribution {
    match (lhs, rhs) {
        ...
        (SecretKeyDistribution::Custom(lhs_can_norm), SecretKeyDistribution::Custom(rhs_can_norm)) => {
            SecretKeyDistribution::Custom(f64::max(lhs_can_norm, rhs_can_norm))
        }
        (SecretKeyDistribution::Custom(_), _) => lhs,
        (_, SecretKeyDistribution::Custom(_)) => rhs,
        (SecretKeyDistribution::UniformTernary, SecretKeyDistribution::UniformTernary) => {
            SecretKeyDistribution::UniformTernary
        }
        (SecretKeyDistribution::SparseWithHwt(lhs_hwt), SecretKeyDistribution::SparseWithHwt(rhs_hwt))
            if lhs_hwt == rhs_hwt =>
        {
            SecretKeyDistribution::SparseWithHwt(lhs_hwt)
        }
...
impl NaiveBGVNoiseEstimator {
    fn descriptor<Params: BGVInstantiation>(
        log2_relative_critical_quantity: f64,
        implicit_scale: ImplicitScale<Params>,
        sk: SecretKeyDistribution,
    ) -> CiphertextDescriptor<Params, Self> {
        assert!(!log2_relative_critical_quantity.is_nan());
        CiphertextDescriptor::new(
            NaiveBGVNoiseEstimatorNoiseDescriptor {
                log2_relative_critical_quantity,
            },
            implicit_scale,
            sk,
        )
...
impl<Params: BGVInstantiation> BGVNoiseEstimator<Params> for NaiveBGVNoiseEstimator {
    ...
    fn estimate_log2_relative_noise_level(
        ...
        // we subtract `(C.rank() as f64).log2()`, since that should be about the difference between `l_inf`
        // and canonical norm
    ...
    fn clone_ct(
        &self,
        P: &PlaintextRing<Params>,
        _C: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> CiphertextDescriptor<Params, Self> {
        Self::descriptor::<Params>(
            ct.noise.log2_relative_critical_quantity,
            P.base_ring().clone_el(&ct.implicit_scale),
            ct.sk,
        )
    }
    ...
    fn enc_sym_zero(
        ...
        let result = t_log2::<Params>(P) + log2_can_norm_sk_estimate::<Params>(C, sk)
            - BigIntRing::RING.abs_log2_floor(C.base_ring().modulus()).unwrap() as f64;
    ...
    fn hom_mul_plain_encoded(
        ...
        Self::descriptor::<Params>(
            ct.noise.log2_relative_critical_quantity + log2_can_norm_shortest_lift_estimate::<Params>(P),
            P.base_ring().clone_el(&ct.implicit_scale),
            ct.sk,
        )
    }
    ...
    fn hom_mul_plain_int(
        ...
        Self::descriptor::<Params>(
            ct.noise.log2_relative_critical_quantity + ZZbig.abs_log2_ceil(m).unwrap_or(0) as f64,
            P.base_ring().clone_el(&ct.implicit_scale),
            ct.sk,
        )
    }
    ...
    fn hom_add(
        ...
        let result = f64::max(
            lhs.noise.log2_relative_critical_quantity,
            rhs.noise.log2_relative_critical_quantity,
        );
        Self::descriptor::<Params>(
            result,
            add_scale::<Params>(P, &lhs.implicit_scale, &rhs.implicit_scale, policy),
            assert_sk_distr_match(lhs.sk, rhs.sk),
        )
    }
    ...
    fn key_switch(
        ...
        let log2_largest_digit = switch_key
            .digits
            .iter()
            .map(|digit| {
                digit
                    .iter()
                    .map(|i| *C_special.base_ring().at(i).modulus() as f64)
                    .map(f64::log2)
                    .sum::<f64>()
            })
            .max_by(f64::total_cmp)
            .unwrap();
        let special_modulus_log2 = special_modulus_rns_factor_indices
            .iter()
            .map(|i| *C_special.base_ring().at(*i).modulus() as f64)
            .map(f64::log2)
            .sum::<f64>();
    ...
    fn mod_switch_ct(
        ...
        let result = f64::max(
            ct.noise.log2_relative_critical_quantity,
            t_log2::<Params>(P) + log2_can_norm_sk_estimate::<Params>(Cnew, ct.sk)
                - BigIntRing::RING.abs_log2_ceil(Cnew.base_ring().modulus()).unwrap() as f64,
        );
        Self::descriptor::<Params>(
            result,
            mod_switch_scale::<Params>(P, Cnew, Cold, &ct.implicit_scale),
            ct.sk,
        )
    }
    ...
    fn hom_mul(
        ...
        let log2_q = BigIntRing::RING.abs_log2_ceil(C.base_ring().modulus()).unwrap() as f64;
        let result =
            (lhs.noise.log2_relative_critical_quantity + rhs.noise.log2_relative_critical_quantity + 2. * log2_q)
                * HEURISTIC_FACTOR_MUL_INPUT_NOISE
                - log2_q;
        let result_no_relin = Self::descriptor::<Params>(
            result,
            mul_scale::<Params>(P, &lhs.implicit_scale, &rhs.implicit_scale),
            assert_sk_distr_match(lhs.sk, rhs.sk),
        );
    ...
    fn fake_mod_switch_down_ct(
        ...
        let result = ct.noise.log2_relative_critical_quantity
            + ZZbig.abs_log2_ceil(Cold.base_ring().modulus()).unwrap() as f64
            - ZZbig.abs_log2_floor(Cnew.base_ring().modulus()).unwrap() as f64;
    ...
    fn change_plaintext_modulus(
        ...
        Self::descriptor::<Params>(
            ct.noise.log2_relative_critical_quantity,
            change_plaintext_modulus_scale::<Params>(Pnew, Pold, &ct.implicit_scale),
            ct.sk,
        )
    }
}
...
impl<Params: BGVInstantiation> BGVNoiseEstimator<Params> for AlwaysZeroNoiseEstimator {
    ...
    fn estimate_log2_relative_noise_level(
        ...
        _P: &PlaintextRing<Params>,
        _C: &CiphertextRing<Params>,
        _ct: &CiphertextDescriptor<Params, Self>,
    ) -> f64 {
        0.
    }
    ...
    fn hom_mul(
        ...
        P: &PlaintextRing<Params>,
        _C: &CiphertextRing<Params>,
        _C_special: &CiphertextRing<Params>,
        lhs: &CiphertextDescriptor<Params, Self>,
        rhs: &CiphertextDescriptor<Params, Self>,
        _rk: KeySwitchKeyDescriptor,
    ) -> CiphertextDescriptor<Params, Self> {
        CiphertextDescriptor::new(
            (),
            P.base_ring().mul_ref(&lhs.implicit_scale, &rhs.implicit_scale),
            assert_sk_distr_match(lhs.sk, rhs.sk),
        )
    }
    ...
    fn fake_mod_switch_down_ct(
        &self,
        P: &PlaintextRing<Params>,
        _Cnew: &CiphertextRing<Params>,
        _Cold: &CiphertextRing<Params>,
        ct: &CiphertextDescriptor<Params, Self>,
    ) -> CiphertextDescriptor<Params, Self> {
        CiphertextDescriptor::new((), P.base_ring().clone_el(&ct.implicit_scale), ct.sk)
    }
