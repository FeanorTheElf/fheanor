# Implementing BFV using this crate, version 2
...
# use anonymizedhelibrary::ciphertext_ring::double_rns_ring::*;
# use anonymizedhelibrary::number_ring::quotient_by_int::*;
...
fn create_ciphertext_ring(ring_degree: usize, mut number_of_rns_factors: usize) -> CiphertextRing {
    ...
    return <CiphertextRing as RingStore>::Type::new(
        Pow2CyclotomicNumberRing::new(m as u64),
...
```
Note that this crate provides the convenience function [`sample_primes()`] and [`extend_sampled_primes()`] to simplify this:
```rust
# use feanor_math::algorithms::miller_rabin::*;
# use feanor_math::ring::*;
# use feanor_math::rings::zn::*;
...
The details are not overly complicated, but would go beyond the scope of this introduction, so we just describe how to use the RNS conversion implementations that are implemented in this crate.
...
# use rand_distr::StandardNormal;
# use anonymizedhelibrary::number_ring::*;
# use anonymizedhelibrary::rns_conv::bfv_rescale::AlmostExactRescalingConvert;
# use anonymizedhelibrary::rns_conv::RNSOperation;
# use anonymizedhelibrary::number_ring::pow2_cyclotomic::*;
# use anonymizedhelibrary::ciphertext_ring::BGFVCiphertextRing;
# use anonymizedhelibrary::ciphertext_ring::double_rns_ring::*;
# use anonymizedhelibrary::number_ring::quotient_by_int::*;
# use anonymizedhelibrary::rns_conv::matrix_lift::AlmostExactMatrixBaseConversion;
# type NumberRing = Pow2CyclotomicNumberRing;
# type PlaintextRing = NumberRingQuotientByInt<NumberRing, zn_64::Zn>;
# type CiphertextRing = DoubleRNSRing<NumberRing>;
# fn create_multiplication_ring(ciphertext_ring: &CiphertextRing) -> CiphertextRing {
...
#     return (ciphertext_ring.add(e, ciphertext_ring.mul_ref(&a, sk)), ciphertext_ring.negate(a));
# }
type RelinKey = (RNSGadgetProductRhsOperand<<CiphertextRing as RingStore>::Type>, RNSGadgetProductRhsOperand<<CiphertextRing as RingStore>::Type>);
...
fn relinearize(
    ...
    let c2_decomposition = RNSGadgetProductLhsOperand::from_double_rns_ring_with(ciphertext_ring.get_ring(), &three_component_ciphertext.2, relin_key.0.gadget_vector_digits());
...
Nevertheless, there does remain some optimization potential:
 - Currently, the native NTT is the same as in `feanor-math`, and it is not quite as fast as others.
